...
<html>
    <head>
        ...
        <title>Vendite - Tabaccheria Online</title>
    ...
    <body>
        ...
        ?>
        <div class=box>
            <div class="nuovo_button" style="margin-top:20px"><a href="statistiche.php">STATISTICHE</a></div>
            <h1>Vendite</h1>
            ...
            <br/>
            <b>Venduti nell'ultima settimana:</b>
            <br/>
            <table>
                ...
                $sql="SELECT v.id, v.aams_code, pezzi, t.descrizione, data, prezzo_unitario AS prezzo FROM Vendita v, Tabacco t "
                    ...
                    .$tabaccheria_comune."' AND v.aams_code = t.aams_code AND data BETWEEN '"
                    .date("Y-m-d H:i:s",strtotime(date("Y-m-d H:i:s")." -7 days"))."' AND '".date("Y-m-d H:i:s")."' ORDER BY data DESC;";
                        ...
                        for ($i = 0; $i < $num_righe; $i++) {
                            ...
                            if (isset($_GET["modifica"])&&$_GET["modifica"]==$id) {
                                ...
                                echo "<tr><td>".$data."</td><td>".$aams."</td><td>".$row["descrizione"]."</td><td>".$row["pezzi"]
                                    ."</td><td>".$prezzo." &euro;</td><td><a href='vendite.php?modifica=".$id."#".$id
            ...
            ?>
            <p><a href="elencovendite.php">Elenco completo</a></p>
        </div>
        <!--carica per ultimi-->
